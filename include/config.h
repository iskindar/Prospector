...
#define BEGIN_EXPLORE_TLIMIT  (30 * 60 * 1000U) //30 min default
#define INTER_EXPLORE_TLIMIT  (20 * 60 * 1000U) //30 min default
#define INTRA_EXPLORE_TLIMIT  (20 * 60 * 1000U) //20 min default
#define TARGET_EXPLOIT_TLIMIT (30 * 60 * 1000U) //60 min default
#define LOG_FREQUENCY_TLIMIT  (30 * 60 * 1000U)
#define SHORT_TIME_LIMIT  (40 * 60 * 1000U)
#define SKIP_DET_US_TLIMIT    (3600 * 1000000U)
...
#define ACO_GRAV_BIAS (1 - ACO_COEF) * INIT_BYTE_SCORE
